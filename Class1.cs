...
namespace ConsoleApp1
{
    internal class Menu
    {
        ...
        private void Drew_Arrow(List<Menu> list) // функция отоброжения стрелочной функции
        {
        ...
        public void Drew_Menu(List<Menu> list) // функция отображения пунктом меню
        {
        ...
        private void Drew_Element_List(List<Menu> list) // функция отображения подпунктов
        {
        ...
        private void CreateFielOrder() // функция создания файла с заказом
        {
